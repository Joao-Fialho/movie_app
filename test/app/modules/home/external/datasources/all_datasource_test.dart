...
import 'package:movie_app/app/modules/home/external/datasources/all_datasource.dart';

class DioMock extends Mock implements Dio {}

void main() {
  final Dio dio = DioMock();
  final AllDatasource datasource = AllDatasource(dio);
  test(
    'espero que meu datasource me retorne uma Lista de allEntity',
    () async {
      ...
      final List<AllEntity> body = await datasource.fetchAll();
      expect(body, isA<List<AllEntity>>());
    },
  );
...
''',
      ...
      expect(() => datasource.fetchAll(), throwsA(isA<AllDatasourceError>()));
    },
  );
}
